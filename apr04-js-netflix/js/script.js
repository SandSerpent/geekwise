...
function getMovies(movies){
  var main = document.querySelector('main'),
      ...
      h1 = document.createElement('h1'), div, title, overview,
  ...
  movies.results.forEach(function(e){
    ...
    var year = e.release_date.split('-').splice(0, 1);
    var average = " Movie Average: " + e.vote_average/2;

    div.append(title, year, average, overview);
